                ...
                <div class="navbar-custom-menu">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <img src="/img/<?= ucwords(session()->get('foto_user')); ?>" class="user-image" alt="User Image">
                                <span class="hidden-xs"><?= ucwords(session()->get('nama_user')); ?></span>
                            </a>
                            <ul class="dropdown-menu">
                                <!-- User image -->
                                <li class="user-header">
                                    ...
                                    <p>
                                        <?= ucwords(session()->get('nama_user')); ?> - <?= session()->get('email'); ?>
                                        <small>
